...
async function initData() {
  ...
  data.push(await d3.csv('https://lee-leonardo.github.io/uiucs416-final/data/step_1.csv'))
  data.push(await d3.csv('https://lee-leonardo.github.io/uiucs416-final/data/step_2.csv'))
  data.push(await d3.csv('https://lee-leonardo.github.io/uiucs416-final/data/BGG_Data_Set_original.csv'));
